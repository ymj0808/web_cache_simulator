...
public:
  ...
  // std::map<unsigned int, virtual_node*> virtual_node_map_uid;     // uid to
  // virtual node
  ...
  // std::map<unsigned int, virtual_node*>::iterator iter_pt;           // debug
  ...
  look_up_simple(const std::string &content);
